...
const Projects = () => {
  ...
  return <section id="work" className="min-h-screen px-6 md:px-12 lg:px-24 py-16 md:py-20 relative">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16 flex items-end justify-between">
          ...
          <p className="hidden md:block text-sm text-muted-foreground max-w-xs text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          return <a key={project.title} href={project.link} target="_blank" rel="noopener noreferrer" className="group block">

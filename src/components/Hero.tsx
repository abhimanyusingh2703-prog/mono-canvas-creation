const Hero = () => {
  ...
  return (
    <section className="min-h-screen px-6 md:px-12 lg:px-24 py-20 md:py-32 relative overflow-hidden noise">
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-8 grid sm:grid-cols-2 gap-6">
                {skills.map((skill, index) => (
                  <div 
                    key={skill.name}
                    className="group border border-border hover:border-foreground transition-all duration-300 p-6 hover:bg-secondary/20"
                  >
